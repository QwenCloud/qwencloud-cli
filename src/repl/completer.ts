...
export const SUBCOMMANDS: Record<string, string[]> = {
  ...
  billing: ['limit', 'breakdown', 'summary', 'payment-method'],
  docs: ['search', 'view'],
  subscription: ['status', 'orders', 'tokenplan'],
  'subscription tokenplan': ['status', 'seats'],
  'billing payment-method': ['bind', 'list'],
...
export const COMMAND_FLAGS: Record<string, string[]> = {
  ...
  'audio speech': ['--model', '--voice', '--out', '--request', '--api-key', '--format'],
  'audio transcribe': [
    '--model',
    '--language',
    '--wait',
  ...
  'billing payment-method bind': ['--format'],
  'billing payment-method list': ['--format'],
